        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="text-center mb-8 lg:mb-12">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-3 tracking-tight">
              Professional Event Specification
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              Your comprehensive planning document forged with precision
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 lg:p-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              >
                ...
                <span className="text-lg relative z-10">Launch Project & Find Master Craftsmen</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 space-y-8">
        ...
        <section className="bg-white rounded-2xl border-2 border-slate-200 shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
          ...
          <div className="p-6 lg:p-8">
            <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 border-2 border-slate-200 rounded-xl p-5 hover:border-blue-300 focus-within:border-blue-400 focus-within:ring-4 focus-within:ring-blue-100 transition-all duration-300">
              <textarea
                ...
                placeholder="Provide a high-level overview of your event..."
              />
            </div>
                        ...
                        {!isLast && (
                          <div className="flex items-center space-x-2 text-xs text-slate-500">
                            ...
                            <span className="font-medium">
                              {(() => {
                                const eventDate = new Date(clientBrief.date || '');
                                const milestoneDate = new Date(milestone.date + ', ' + eventDate.getFullYear());
                                const daysUntilEvent = Math.ceil((eventDate.getTime() - milestoneDate.getTime()) / (1000 * 60 * 60 * 24));
          ...
          <div className="relative p-8 lg:p-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-white/90 max-w-2xl mx-auto">
                Connect with Kerala's top master craftsmen and receive competitive proposals within 48 hours
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-8">
              <div className="bg-white/20 backdrop-blur-md rounded-2xl border border-white/30 p-6 text-center transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-white/90 font-medium">Verified Craftsmen</div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/30 p-6 lg:p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-white/80">Your specification reaches qualified craftsmen in relevant categories</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-bold text-white mb-2">Receive Proposals</h4>
                  <p className="text-sm text-white/80">Craftsmen submit detailed bids with pricing and visual concepts</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-bold text-white mb-2">Select & Book</h4>
                  <p className="text-sm text-white/80">Compare offers, shortlist top 5, and commission your chosen craftsman</p>
                </div>
              </div>
            </div>
            ...
            <button
              onClick={onLaunchProject}
              className="w-full group relative overflow-hidden bg-white hover:bg-slate-50 text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600 font-bold text-xl py-6 rounded-2xl flex items-center justify-center space-x-4 shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:scale-[1.02] min-h-[44px]"
              style={{ color: 'transparent', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
            >
              ...
              <span className="relative z-10 bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600 bg-clip-text" style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                Launch Project & Find Master Craftsmen
              </span>
            </button>
